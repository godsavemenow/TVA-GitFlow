...
final class CurrencyListViewModel {
    ...
    let nominhos = Currency(success: true,
                            currencies: ["Jéssica" : "Amaral", "Luis" : "Pereira", "Iris" : "", "Hugo" : "", "Ana" :  "Clara", "Erick" : "Almeida", "Vítor" : "Bárrios", "Marina" : "Lima", "Julia" : "", "Elaine" : "", "Eduardo" : "Lopes", "Dudu" : "Ramos", "Juliano" : "Vaz", "Lívia" : "Oliveira", "Pedro" : "Spinola", "Morgana" : "", "Henrique" : "Fernandes", "Mayara" : "", "Nádia" : "Bordoni", "Alexandra" : "", "Evaldo" : "Júnior", "Dara" : "Vaconcelos", "Palloma" : "", "Meyri" : ""])
